...
function buildCarsPage() {
  const cars = [
    { make:'Toyota',   model:'Corolla 1.6 GLi Auto',  year:'2020', km:'45K km',  trans:'Automatic', fuel:'Petrol',  city:'Lahore',    price:'42 Lac',   badge:'badge-feat', badgeTxt:'FEATURED', img:'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=500&h=260&fit=crop' },
    { make:'Honda',    model:'Civic RS Turbo 1.5T',    year:'2023', km:'12K km',  trans:'Automatic', fuel:'Petrol',  city:'Karachi',   price:'74 Lac',   badge:'badge-new',  badgeTxt:'NEW',      img:'https://images.unsplash.com/photo-1580274455191-1c62238fa333?w=500&h=260&fit=crop' },
    { make:'Kia',      model:'Sportage AWD Alpha',     year:'2022', km:'32K km',  trans:'Automatic', fuel:'Petrol',  city:'Islamabad', price:'78 Lac',   badge:'badge-hot',  badgeTxt:'HOT',      img:'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=500&h=260&fit=crop' },
    { make:'Suzuki',   model:'Swift GL Automatic',     year:'2021', km:'28K km',  trans:'Automatic', fuel:'Petrol',  city:'Multan',    price:'28 Lac',   badge:'',           badgeTxt:'',         img:'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?w=500&h=260&fit=crop' },
    { make:'Toyota',   model:'Land Cruiser GX 4x4',   year:'2019', km:'75K km',  trans:'Automatic', fuel:'Diesel',  city:'Karachi',   price:'2.6 Crore',badge:'',           badgeTxt:'',         img:'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=500&h=260&fit=crop' },
    { make:'BMW',      model:'3 Series 320i Sport',   year:'2021', km:'40K km',  trans:'Automatic', fuel:'Petrol',  city:'Lahore',    price:'1.4 Crore',badge:'',           badgeTxt:'',         img:'https://images.unsplash.com/photo-1555652736-e92021d28a10?w=500&h=260&fit=crop' },
    { make:'Honda',    model:'City 1.2 Manual',        year:'2022', km:'18K km',  trans:'Manual',    fuel:'Petrol',  city:'Faisalabad',price:'22 Lac',   badge:'badge-new',  badgeTxt:'NEW',      img:'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=500&h=260&fit=crop' },
    { make:'Suzuki',   model:'Alto VXL 2023',          year:'2023', km:'5K km',   trans:'Manual',    fuel:'Petrol',  city:'Lahore',    price:'14 Lac',   badge:'badge-new',  badgeTxt:'NEW',      img:'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?w=500&h=260&fit=crop' },
    { make:'Hyundai',  model:'Tucson AWD 2.0',         year:'2022', km:'24K km',  trans:'Automatic', fuel:'Petrol',  city:'Islamabad', price:'70 Lac',   badge:'badge-hot',  badgeTxt:'HOT',      img:'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=500&h=260&fit=crop' },
    { make:'Toyota',   model:'Prius Hybrid 2020',      year:'2020', km:'55K km',  trans:'Automatic', fuel:'Hybrid',  city:'Karachi',   price:'38 Lac',   badge:'',           badgeTxt:'',         img:'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=500&h=260&fit=crop' },
    { make:'Kia',      model:'Picanto 1.0 Auto',       year:'2023', km:'8K km',   trans:'Automatic', fuel:'Petrol',  city:'Lahore',    price:'24 Lac',   badge:'badge-new',  badgeTxt:'NEW',      img:'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=500&h=260&fit=crop' },
    { make:'Mercedes', model:'C200 AMG Package',       year:'2020', km:'60K km',  trans:'Automatic', fuel:'Petrol',  city:'Karachi',   price:'1.8 Crore',badge:'badge-feat', badgeTxt:'FEATURED', img:'https://images.unsplash.com/photo-1555652736-e92021d28a10?w=500&h=260&fit=crop' },
  ];
...
function buildBikesPage() {
  const bikes = [
    { brand:'Honda',  model:'CB-150F Sports Edition', cc:'150', condition:'New',  city:'Lahore',    price:'3,25,000', badge:'badge-new', badgeTxt:'NEW', img:'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=500&h=260&fit=crop' },
    { brand:'Yamaha', model:'YBR 125G Off-Road',       cc:'125', condition:'Used', city:'Karachi',   price:'2,85,000', badge:'',          badgeTxt:'',    img:'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=500&h=260&fit=crop' },
    { brand:'Honda',  model:'CD-70 Dream Classic',     cc:'70',  condition:'New',  city:'Faisalabad',price:'1,85,000', badge:'badge-hot', badgeTxt:'HOT', img:'https://images.unsplash.com/photo-1609621838510-5ad474b7d25d?w=500&h=260&fit=crop' },
    { brand:'Suzuki', model:'GD-110S City Rider',      cc:'110', condition:'Used', city:'Islamabad', price:'2,10,000', badge:'',          badgeTxt:'',    img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=260&fit=crop' },
    ...
    { brand:'Honda',  model:'CG-125 Self Start',       cc:'125', condition:'New',  city:'Multan',    price:'2,20,000', badge:'badge-feat',badgeTxt:'FEAT',img:'https://images.unsplash.com/photo-1609621838510-5ad474b7d25d?w=500&h=260&fit=crop' },
    { brand:'United', model:'US-70 Economy',           cc:'70',  condition:'New',  city:'Lahore',    price:'1,60,000', badge:'',          badgeTxt:'',    img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=260&fit=crop' },
...
function buildElectronicsPage() {
  const items = [
    ...
    { cat:'Mobile Phones', brand:'Samsung', name:'Galaxy S24 Ultra 512GB',     price:320000, priceDisp:'3,20,000', oldPrice:'',         disc:'',    badge:'badge-hot', badgeTxt:'HOT', stars:'★★★★☆', rev:'(154)',  img:'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=380&h=260&fit=crop', condition:'New' },
    { cat:'Mobile Phones', brand:'Xiaomi',  name:'Redmi Note 13 Pro 256GB',    price:65000,  priceDisp:'65,000',   oldPrice:'75,000',   disc:'-14%', badge:'badge-sale',badgeTxt:'-14%',stars:'★★★★★',rev:'(312)',  img:'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=380&h=260&fit=crop', condition:'New' },
    ...
    { cat:'Laptops',       brand:'Dell',    name:'XPS 15 i9 RTX 4060',         price:480000, priceDisp:'4,80,000', oldPrice:'',         disc:'',    badge:'badge-new', badgeTxt:'NEW', stars:'★★★★★', rev:'(33)',   img:'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=380&h=260&fit=crop', condition:'New' },
    { cat:'Laptops',       brand:'Lenovo',  name:'ThinkPad X1 Carbon i7',      price:220000, priceDisp:'2,20,000', oldPrice:'',         disc:'',    badge:'',          badgeTxt:'',    stars:'★★★★☆', rev:'(67)',   img:'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=380&h=260&fit=crop', condition:'Used' },
    { cat:'Audio',         brand:'Sony',    name:'WH-1000XM5 Headphones',      price:45000,  priceDisp:'45,000',   oldPrice:'60,000',   disc:'-25%', badge:'badge-sale',badgeTxt:'-25%',stars:'★★★★★',rev:'(220)',  img:'https://images.unsplash.com/photo-1546435770-a3e736769abd?w=380&h=260&fit=crop', condition:'New' },
    ...
    { cat:'TVs',           brand:'Samsung', name:'Samsung 55" 4K QLED Smart TV',price:160000,priceDisp:'1,60,000', oldPrice:'',         disc:'',    badge:'badge-feat', badgeTxt:'FEAT',stars:'★★★★★',rev:'(78)',   img:'https://images.unsplash.com/photo-1593359677879-a4bb92f4f8f3?w=380&h=260&fit=crop', condition:'New' },
    { cat:'TVs',           brand:'Sony',    name:'Sony Bravia 65" OLED 4K',    price:320000, priceDisp:'3,20,000', oldPrice:'',         disc:'',    badge:'badge-new', badgeTxt:'NEW', stars:'★★★★★', rev:'(34)',   img:'https://images.unsplash.com/photo-1593359677879-a4bb92f4f8f3?w=380&h=260&fit=crop', condition:'New' },
    ...
    { cat:'Cameras',       brand:'Sony',    name:'Sony A7 IV Full Frame',      price:420000, priceDisp:'4,20,000', oldPrice:'',         disc:'',    badge:'badge-hot', badgeTxt:'HOT', stars:'★★★★★', rev:'(28)',   img:'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=380&h=260&fit=crop', condition:'New' },
